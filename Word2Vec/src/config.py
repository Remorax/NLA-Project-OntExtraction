...
conf={}
conf['model'] = "GoogleNews-vectors-negative300.bin" # default dummy model
#conf['model'] = "climate2_2015_7.txt.2gram.model"



# if using a bigram model
conf['seedfn'] = "../data/security.seed" # bigram seed for climate change models 
...
conf['domain'] = "security" # your domain of knowledge -- not important for the algorithms ..
